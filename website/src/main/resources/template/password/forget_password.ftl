...
<head>
    ...
    <link rel="stylesheet" href="${resourcesPath}/resources/css/pdws.css?v=${resourcesVersion!}">
        ...
        <div class="w1120 content ">
            ...
            <div class="con">
                <div class="amend relative">
                    <ul class="btn-ul ">
                        <li class="on"><p>安全验证</p>
                            <span class="rings"></span>
                        </li>
                        <li class="text-center"><p>设置新密码</p><span class="rings div-2-span"></span></li>
                        <li class="text-right"><p>设置成功</p><span class="rings div-3-span"></span></li>
                    </ul>
                    <div class="lines"></div>
                </div>
                ...
                <div class="con-li div-2">
                    <div class="w288 ">
                        <div class="relative mb60">
                            ...
                            <p style="display: none;" class="color48 font12 error-text  passwordVerify">密码格式错误，请输入6~20位密码，且必须含数字/字母/字符中的至少两种组合</p>
                        </div>
