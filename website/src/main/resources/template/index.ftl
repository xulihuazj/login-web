...
<head>
    ...
    <@seo.seo></@seo.seo>
    <link rel="stylesheet" href="${resourcesPath}/resources/css/index.css?v=${resourcesVersion!}">
</head>
<body>
<div class="box">
    <!-- 导航 -->
        ...
        <div class="bgimg">
            <div class="part1 w1120">
                <div class="part-top relative">
                    <h2 class="color27 text-center font32">热门电影推荐</h2>
                    <p class="color99 text-center font14">电影、电视剧、动漫、综艺下载就在“大世界电影网”</p>
                </div>
                <div id="house">
                    <!-- 异步加载内容 -->
                </div>
...
<script>
    ...
    $(function () {
        ...
        // 首页推荐
        $.HTTP.GetHTML($.HTTP.URL.MOVIE_RECOMMEND_URL, {
            pageNum:1,
            pageSize:10
        }, function (data) {
            $("#house").html(data);
