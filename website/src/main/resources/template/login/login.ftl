        ...
        <div class="login-card">
            ...
            <div class="login-content">
                ...
                <div class="form-group relative">
                    <input name="pwd" type="password" maxlength="20" id="password_value" placeholder="请输入6-20位登录密码"
                           class="w-100">
                ...
                <div class="login-forgot"><span class="font14"
                                                onclick="window.location.href='${basePath}/user/forget/password'"
                                                style="cursor: pointer;">忘记密码</span></div>
                <div class="login-reg font14">没有账号，立即 <a href="${basePath}/user/register/page" class="font14">注册</a>
                </div>
            </div>
        </div>
    </div>
